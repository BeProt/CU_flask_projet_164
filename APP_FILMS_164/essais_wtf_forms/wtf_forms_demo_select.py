...
"""
    ...
    But : Montrer l'utilisation d'une liste déroulante (WTF) dont le contenu est basé sur la table "t_entrepot"
...
class DemoFormSelectWTF(FlaskForm):
    ...
    #                                   coerce=int
    #                                   )
    submit_btn_ok_dplist_entrepot = SubmitField("Choix genre")
